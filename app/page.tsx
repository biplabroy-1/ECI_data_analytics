                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-2xl font-bold">
                              {processedData.executiveSummary.overall_integrity_score.toFixed(
                                1
                              )}
                              %
                            </p>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-2xl font-bold">
                              {processedData.executiveSummary.total_voters.toLocaleString()}
                            </p>
                          </div>
                      ...
                      <CardContent className="p-6">
                        ...
                        {processedData ? (
                          <div className="space-y-3">
                            <div className="flex justify-between">
                              ...
                              <Badge variant="secondary">
                                {processedData.uploadData.metadata.total_pages}
                              </Badge>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-sm text-gray-600">
                              ...
                              <Badge variant="outline">
                                {processedData.uploadData.images_processed}
                              </Badge>
                            </div>
                          ...
                          <p className="text-gray-500 text-sm">
                            Upload a document to view metadata
                          </p>
                        )}
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardContent className="p-6">
                        <pre className="whitespace-pre-wrap text-sm bg-gray-50 p-4 rounded-lg overflow-auto">
                          {JSON.stringify(
                            processedData?.uploadData.metadata || {},
                            null,
                            2
                          )}
                        </pre>
                    ...
                    <Card className="border-0 shadow-xl bg-white/70 backdrop-blur-sm hover:shadow-2xl transition-all duration-200 cursor-pointer group">
                      <CardContent className="p-6">
                        ...
                        {processedData ? (
                          <div className="space-y-3">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                >
                                  {
                                    processedData.executiveSummary
                                      .voters_flagged_high_risk.count
                                  }
                                </Badge>
                                <span className="text-xs text-gray-500">
                                  (
                                  {processedData.executiveSummary.voters_flagged_high_risk.percentage.toFixed(
                                    1
                                  )}
                                  %)
                                </span>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                <Badge variant="secondary" className="text-xs">
                                  {
                                    processedData.executiveSummary
                                      .voters_flagged_medium_risk.count
                                  }
                                </Badge>
                                <span className="text-xs text-gray-500">
                                  (
                                  {processedData.executiveSummary.voters_flagged_medium_risk.percentage.toFixed(
                                    1
                                  )}
                                  %)
                                </span>
                          ...
                          <p className="text-gray-500 text-sm">
                            Upload a document to view summary
                          </p>
                        )}
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-0 shadow-xl bg-white/70 backdrop-blur-sm hover:shadow-2xl transition-all duration-200 cursor-pointer group">
                      <CardContent className="p-6">
                        ...
                        {processedData ? (
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <p className="font-semibold text-blue-600">
                                  {
                                    processedData.analysisData.sequential_runs
                                      .length
                                  }
                                </p>
                              </div>
                          ...
                          <p className="text-gray-500 text-sm">
                            Upload a document to view analysis
                          </p>
                        )}
                      </CardContent>
                    </Card>
                        ...
                        <div className="space-y-6">
                          ...
                          <Card>
                            ...
                            <CardContent>
                              ...
                              0 ? (
                                <div className="space-y-4">
                                  {processedData.analysisData.duplicates.map(
                                    (duplicate, index) => (
                                      <Card
                                        key={index}
